# calories.md — Build Complete ✅

**Domain:** calories.md  
**Topic:** Evidence-based nutrition, calorie tracking, metabolism  
...
1. **GitHub Repository**
   ```bash
   gh repo create loki-mamv/calories-md --public
   gh api repos/loki-mamv/calories-md/collaborators/mike32snake -X PUT -f permission=admin
   ```
...
3. **Configure DNS**
   ...
   - Point calories.md to loki-mamv.github.io
...
**Output Location:** `/Users/loki/assistant/output/md-sites/remaining/calories/`  
